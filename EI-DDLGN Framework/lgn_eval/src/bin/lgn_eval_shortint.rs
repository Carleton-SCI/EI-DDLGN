...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let engine = ShortintEngine::new_with_param(parameters::v1_1::V1_1_PARAM_MESSAGE_1_CARRY_1_KS_PBS_GAUSSIAN_2M64);
    println!("  Key+LUT generation done in {:.3}s", keygen_start.elapsed().as_secs_f64());
