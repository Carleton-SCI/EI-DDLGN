...
def save_experiment_report(settings, results):
    ...
    model_path = Path("mnist.qat.onnx")
...
def main():
    ...
    lr = 0.02
    gamma = 0.33
    test_data_length_reduced = 5  # This notably drives FHE timing stability
    ...
    save_experiment_report(experiment_settings, experiment_results)
